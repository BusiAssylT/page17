...
const podcastEpisodes = [
  {
    number: "01",
    series: "Непростые истории простых людей",
    guest: "Бота Саду",
    guestRole: "медицинский представитель, блогер, общественный деятель",
    title: "Как пройти кризис и не потерять себя",
    subtitle: "Откровенный разговор с Ботой Саду о материнстве, разводе, болезни, вере, блогерстве и внутренней опоре.",
    url: "https://youtu.be/mLO7DZBuRyg?si=biMcqOUuM5JH4E4s",
    embedUrl: "https://www.youtube.com/embed/mLO7DZBuRyg",
    date: "4 июля 2026",
    note: "В первом выпуске серии героиня говорит о том, как проживать трудные периоды, оставаться мамой, профессионалом и человеком, который выбирает честность с собой. Это разговор о боли, благодарности, личных границах и силе, которая появляется после кризисов.",
    topics: ["материнство", "развод и принятие", "вера и болезнь", "Instagram без маски", "личные границы"],
    takeaways: [
      "почему роль мамы для Боты важнее социальных статусов",
      "как блог может стать личным дневником и поддержкой для других",
      "что помогает проходить развод, болезнь и периоды внутренней перестройки",
      "почему искренность в Instagram не обязана означать жизнь без границ"
    ]
  }
];
...
const pageData = {
  ...
  authors: {
    tag: "Авторам",
    title: "Ваша книга заслуживает не только публикации, но и живого разговора.",
    lead: "PAGE17 помогает авторам встретиться с читателями, получить честную обратную связь, рассказать о своей книге и стать частью литературного сообщества.",
    cta: "Обсудить сотрудничество",
    mini: ["Что мы можем сделать вместе", "Почему PAGE17", "Первый шаг", "Обсудить сотрудничество"],
    rows: [
      ["Что мы можем сделать вместе", "Организовать встречу с читателями, провести презентацию книги, подготовить интервью или серию публикаций, создать медиаматериалы, включить книгу в обсуждения клуба, познакомить вас с библиотеками, издательствами и другими партнёрами или разработать долгосрочную программу продвижения."],
      ["Почему PAGE17", "Мы не просто организуем мероприятие. Мы создаём пространство, в котором книга продолжает жить после выхода в свет. Для нас важно не количество событий, а качество связей между автором, читателями и литературным сообществом."],
      ["Первый шаг", "Если вы хотите обсудить возможные форматы сотрудничества, расскажите нам о себе и своей книге. Мы свяжемся с вами и предложим варианты, которые будут соответствовать вашим целям."]
    ]
  },
  libraries: {
    tag: "Библиотекам",
...
function podcastSection() {
  ...
  return `
    <div class="podcast-intro">
      ...
      <h2>Непростые истории простых людей</h2>
      <p>Видеоразговоры PAGE17 о личном пути, кризисах, выборе, вере, культуре и людях, которых хочется услышать внимательнее. Свежий выпуск остается наверху, а предыдущие постепенно уходят ниже в архив.</p>
    </div>
    <div class="episode-layout">
      <div>
        ...
        <article class="episode-card">
          <span class="eyebrow">${episode.series} · Выпуск ${episode.number} · ${episode.date}</span>
          <h2>${episode.title}</h2>
          ...
          <div class="takeaway-list">
            <strong>В выпуске:</strong>
            <ul>
              ${episode.takeaways.map(item => `<li>${item}</li>`).join("")}
            </ul>
          </div>
